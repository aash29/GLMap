...
struct ImGuiIO
{
    ...
    ImVec2        DisplayFramebufferScale;  // = (1.0f,1.0f)        // For retina display or other situations whsere window coordinates are different from framebuffer coordinates. User storage only, presently not used by ImGui.
